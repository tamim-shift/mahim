...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "miss ") || (event.body.toLowerCase() == "miss you")) {
   ...
   if ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning") || (event.body.toLowerCase() == "shuvo sokal")) {
  ...
  if ((event.body.toLowerCase() == "mahim") || (event.body.toLowerCase() == "mahim vai") || (event.body.toLowerCase() == "@mahim.xo.je") || (event.body.toLowerCase() == "মাহিম")) {
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "assalamualaikum") || (event.body.toLowerCase() == "assalamu alaikum") || (event.body.toLowerCase() == "salam ")) {
   ...
   if ((event.body.toLowerCase() == "sla ami tor boss") || (event.body.toLowerCase() == "sla ami mahim") || (event.body.toLowerCase() == "chup sla ami mahim") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "oii") || (event.body.toLowerCase() == "kire")) {
  ...
  if ((event.body.toLowerCase() == "mg") || (event.body.toLowerCase() == "mgi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার Ex এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "mahim") || (event.body.toLowerCase() == "মাহিম")) {
     return api.sendMessage("🥰-𝗺𝗮𝗵𝗶𝗺-🌺 আমার বস এর থেকে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "hum") || (event.body.toLowerCase() == "humm") || (event.body.toLowerCase() == "hm")) {
     return api.sendMessage("️হুম চো₹!ইস না মাথা এমনিতেই গরম আছে🤬⛏️😷", threadID);
   };

   if ((event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "bot ache") || (event.body.toLowerCase() == "Tor name ki")) {
   ...
   if ((event.body.toLowerCase() == "bby") || (event.body.toLowerCase() == "ex")) {
   ...
   if ((event.body.toLowerCase() == "tumi khaiso") || (event.body.toLowerCase() == "khaicho") || (event.body.toLowerCase() == "khaiso bby")) {
     return api.sendMessage("না ঝাং 🥹 তুমি রান্না করে রাখো আমি এসে খাবো <😘", threadID);
   };

   if ((event.body.toLowerCase() == "tumi ki amake bhalobasho") || (event.body.toLowerCase() == "tmi ki amake vlo basho")) {
     return api.sendMessage("হুম ঝাং আমি তোমাকে রাইতে ভলোপাসি <🥵", threadID);
   };

   if ((event.body.toLowerCase() == "ami mahim") || (event.body.toLowerCase() == "kire")) {
     return api.sendMessage("হ্যা বস কেমন আছেন..?☺️", threadID);
   };

   // New Extra Triggers Added Here
   if ((event.body.toLowerCase() == "ki koro") || (event.body.toLowerCase() == "ki korso")) {
     return api.sendMessage("তোমার মেসেজের রিপ্লাই দেওয়ার জন্য বসে আছি জানু 😘", threadID);
   };

   if ((event.body.toLowerCase() == "ki obostha") || (event.body.toLowerCase() == "obostha ki")) {
     return api.sendMessage("অবস্থা তো খুবই টাইট, গার্লফ্রেন্ড নাই তো তাই 😭", threadID);
   };

   if ((event.body.toLowerCase() == "hi") || (event.body.toLowerCase() == "hello") || (event.body.toLowerCase() == "hlw") || (event.body.toLowerCase() == "hallo")) {
     return api.sendMessage("হ্যালো কলিজা! কেমন আছো? 🥰", threadID);
   };

   if ((event.body.toLowerCase() == "vai") || (event.body.toLowerCase() == "bhai") || (event.body.toLowerCase() == "vaiya") || (event.body.toLowerCase() == "bhaia")) {
     return api.sendMessage("ভাই ডাকবি না, আমি তোর ক্রাশ 🙈", threadID);
   };

   if ((event.body.toLowerCase() == "kutta") || (event.body.toLowerCase() == "chagol") || (event.body.toLowerCase() == "pagol")) {
     return api.sendMessage("গাল্লি দিস ক্যান আবাল 🐸 তোর মুখে গন্ধ, দুরে গিয়া মর 😾", threadID);
   };

   if ((event.body.toLowerCase() == "ok") || (event.body.toLowerCase() == "hmm") || (event.body.toLowerCase() == "accha")) {
     return api.sendMessage("হুম হুম করিস না, ভালো কিছু বল 😒", threadID);
   };

   if ((event.body.toLowerCase() == "good night") || (event.body.toLowerCase() == "gd n8") || (event.body.toLowerCase() == "ghumate jabo")) {
     return api.sendMessage("গুড নাইট জানু, স্বপ্নে কিন্তু আমারেই দেখবা 😴❤️", threadID);
   };

   if ((event.body.toLowerCase() == "sad") || (event.body.toLowerCase() == "kosto") || (event.body.toLowerCase() == "kanna")) {
     return api.sendMessage("কান্দিস না ভাই, সব ঠিক হয়ে যাবে 🥹 আমি তো আছি তোর পাশে ❤️", threadID);
   };

   if ((event.body.toLowerCase() == "love you too") || (event.body.toLowerCase() == "love u too")) {
     return api.sendMessage("লজ্জা পাইছি তো 🙈 আসো বুকে আসো ❤️", threadID);
   };

mess = "{name}"
  
  if (event.body && event.body.toLowerCase().trim() == "bot") {
    var msg = {
      body: `${name}, ${rand}`
    }
